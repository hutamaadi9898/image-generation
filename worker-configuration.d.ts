/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fa57b3224608541effae99e7c6fe3edc)
// Runtime types generated with workerd@1.20260312.1 2025-09-27 disable_nodejs_process_v2,global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		RUNPOD_STATUS_POLL_ENABLED: "true";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_BASE_URL" | "JOB_STATUS_POLL_ENABLED" | "RUNPOD_STATUS_POLL_ENABLED" | "GEMINI_MODEL">> {}
}
